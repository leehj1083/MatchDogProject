...
<body>
	...
	<div class="findForm">
		<h2>아이디 찾기</h2>
		<p/>&nbsp<h3>이름</h3>
		<p/><input type="text" name="name" placeholder="이름을 입력 하세요" />
		<p/>&nbsp<h3>이메일</h3>
		<div>
		...
		<c:if test="${checkNum=''}" scope="session" var="accCheck">
			<p/><span id="informId">고객님의 ID는 +${accCheck.id}+입니다.</span>
		</c:if>
		<p/><input type="button" id="login" value="로그인"/>
		<hr/>
		<a href="./pwFind.go">비밀번호 찾기</a> / <a href="./joinAgree.go">회원가입</a>
	</div>
</body>
<script>
