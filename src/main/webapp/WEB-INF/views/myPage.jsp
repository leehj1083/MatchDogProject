...
<div style="display: flex; justify-content: space-between;">
  <strong style="color : var(--green);">기본 정보</strong>
...
<%--  	<p>이름 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${myPage.member_name}</p>
 	...
 	<p>닉네임 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${myPage.member_nickName}</p>
	<p>이메일 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${myPage.member_email}</p>
 	<p>전화번호  ${myPage.member_phone}</p>
 	<p>주소(도로명)  ${myPage.member_roadAddr}</p>
 	<p>주소(지번) ${myPage.member_parcelAddr}</p>
 	<p>상세주소 ${myPage.member_detailAddr}</p> --%>
